...
<head>
    ...
    <style><?php include './skins/css/normalize.less';
        include './skins/css/begin.less'; ?></style> <!--min.css -->
...
<header>
    ...
    <?php if (!isset($_SESSION['user'])) { ?>
        <div class="auth">
            <a href="<?= createUrl('login/registration') ?>"> Регистрация </a> |
            <a href="<?= createUrl('login') ?>"> Авторизация </a>
        </div>
    <?php } else { ?>
        <div class="auth">
