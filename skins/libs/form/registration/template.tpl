<form action="" method="POST" class="form-registration" enctype="multipart/form-data"><table>
    ...
    <tr<?php if(!empty($this->content['email']['error'])) {echo ' style="background-color:#FAA"';} ?>>
      <td><?php echo $this->content['email']['title']; ?></td>
      <td>
        <input type="<?php echo $this->content['email']['type']; ?>" name="<?php echo $this->content['email']['name']; ?>" value="<?php echo $this->content['email']['value']; ?>" <?php echo $this->content['email']['attrs']; ?>>
        <?php if(!empty($this->content['email']['text'])) { ?><br><i><?php echo $this->content['email']['text']; ?></i><?php } ?>
      </td>
      <td>
        <?php echo $this->content['email']['error']; ?>
      </td>
    </tr>
